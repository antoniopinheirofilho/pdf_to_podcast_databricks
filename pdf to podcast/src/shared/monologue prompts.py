...
Create a structured monologue outline synthesizing the following document summaries. The monologue should be 60-90 seconds long.
...
Parameters:
- Duration: 60 seconds (~180 words)
- Speaker: {{ speaker_1_name }}
- Structure: Follow the outline while maintaining:
  * Introduction (10-15 words)
  * Opening (10-15 words)
  * Key points from outline (90-110 words)
  * Supporting evidence (30-40 words)
  * Conclusion (20-35 words)

Requirements:
1. Speech Pattern
   - Introduce yourself briefly and what you are about to do
...
MONOLOGUE_DIALOGUE_PROMPT_STR = """You are tasked with converting a financial monologue into a structured JSON format. Do not output anything besides the JSON. You have:
